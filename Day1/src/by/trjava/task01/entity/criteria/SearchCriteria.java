...
/**
 * This class contains enums of appliances with its criterias
 *
...
public final class SearchCriteria {
    ...
    public static enum Refrigerator {
        POWER_CONSUMPTION, WEIGHT, FREEZER_CAPACITY, OVERALL_CAPACITY,
        HEIGHT, WIDTH;
    }
    ...
    public static enum Speakers {POWER_CONSUMPTION, NUMBER_OF_SPEAKERS, FREQUENCY_RANGE, CORD_LENGTH;
    }
